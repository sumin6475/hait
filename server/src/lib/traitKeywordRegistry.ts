...
const EXTRA_PHRASES: Record<string, { core?: string[]; variants?: string[] }> = {
  ...
  A_n1: { core: ["does not tolerate criticism", "not tolerate criticism"], variants: ["doesn't tolerate criticism", "doesnt tolerate criticism", "cannot tolerate criticism", "can't tolerate criticism", "cannot take criticism", "not tolerant on criticism"] },
  ...
  B_p1: { core: ["keeps a cool head in crisis situations", "cool head in crisis situations"], variants: ["keep a cool head in a crisis", "keeps a cool head in crises", "cool head"] },
  B_p2: { core: ["rely on 100%", "100% reliable"], variants: ["can be relied on 100%", "100 percent reliable", "rely on completely", "reliability", "rely on him/her 100%", "rely on him 100%", "rely on them 100%", "rely on b 100%"] },
  ...
  C_p1: { core: ["make the right decisions very quickly", "right decisions very quickly"], variants: ["makes the right decisions very quickly", "can make correct decisions very quickly", "make the right decision very quickly", "make right decisions quickly", "right decisions quickly"] },
  C_p2: { core: ["stress resistant"], variants: ["stress-resistant", "resistant to stress", "handles stress well"] },
  C_p3: { core: ["good atmosphere within the crew", "promotes a good atmosphere"], variants: ["creates a good atmosphere within the crew", "promotes a good crew atmosphere", "keeps the crew atmosphere good", "promotes good atmosphere with the crew"] },
  ...
  C_p6: { core: ["safety of people above everything", "puts people's safety above everything"], variants: ["puts the safety of people in their care above everything else", "puts people's safety first"] },
  ...
  D_p1: { core: ["react adequately to unforeseen events", "unforeseen events"], variants: ["reacts adequately to unforeseen events", "handles unforeseen events adequately"] },
  D_p2: { core: ["concentrate very well"], variants: ["concentrates very well", "very good concentration"] },
