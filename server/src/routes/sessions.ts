  ...
  try {
    ...
    res.json({
      ...
      interventions: interventions.map((i) => ({
        ...
        requestIntentMethod: i.requestIntentMethod,
        requestIntentClassifierModel: i.requestIntentClassifierModel,
        requestIntentClassifierError: i.requestIntentClassifierError,
