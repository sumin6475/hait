          ...
          {sessions.map((s) => (
            <tr key={s.id} className="hover:bg-muted/20 cursor-pointer transition-colors">
              ...
              <td className="px-5 py-3 text-sm">
                {s.participants.length}/{s.conditionCode === "CTRL" ? 3 : 2}
              </td>
              <td className="px-5 py-3 text-sm text-muted-foreground">
                {s.startedAt
              ...
              <td className="px-5 py-3 text-sm text-muted-foreground">
                {s.metadata?.durationSeconds
                  ? `${Math.round(s.metadata.durationSeconds / 60)} min`
                  : "—"}
              </td>
                ...
                {s.teamDecision ? (
                  <span
                    className={cn(
                      ...
                      s.teamDecision === "C" ? "text-status-success" : "text-destructive",
                    )}
                  >
                    {s.teamDecision}
                  </span>
